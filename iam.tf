...
#data "aws_iam_role" "read_write_encrypt_role" {
#  name = "ReadWriteEncryptSecretsRole"
#}
...
#   # Ability to delegate for for the account
#   statement {
#     effect = "Allow"
#     principals {
#       type        = "AWS"
...
#     principals {
#       type        = "AWS"
#       identifiers = ["${data.aws_iam_role.read_write_encrypt_role.arn}"]
#     }
#     actions = [
#       "kms:Describe*",
#       "kms:Enable*",
...
#       values   = ["arn:aws:secretsmanager:*:${data.aws_caller_identity.current.account_id}:secret:${var.project_short_name}/*"]
#
#     }
#   }
#
